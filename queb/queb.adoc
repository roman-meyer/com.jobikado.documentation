...
Eine mögliche Lösung auf die Probleme könnte sein: ehrliches Feedback der Mitarbeiter erhalten und mit diesen Erkenntnissen um eine hohe Mitarbeiterbindung ringen. Neben der Unternehmensführung ist auch die gelernte bzw. studierte Fachkraft mit Problemen konfrontiert.
